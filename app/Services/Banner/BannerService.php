...
class BannerService
{
    ...
    */
     ...
     * @param \App\Services\Banner\CostCalculator $calculator
     * @param Client $client
     */
     ...
     */
    public function changeFile($id, FileRequest $request)
    {
     ...
     */
    public function editByOwner($id, EditRequest $request)
    {
        $banner = $this->getBanner($id);
        if (!$banner->canBeChanged()) {
            throw new \DomainException('Unable to edit the banner.');
